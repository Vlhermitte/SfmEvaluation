...
for scene in "${SCENES[@]}"; do
  ...
  python src/main.py --est-model-path data/results/vggsfm/ETH3D/${scene}/colmap/sparse/0 --gt-model-path data/datasets/ETH3D/${scene}/dslr_calibration_jpg
done
...
for scene in "${SCENES[@]}"; do
  ...
  python src/main.py --est-model-path data/results/flowmap/ETH3D/${scene}/colmap/sparse/0 --gt-model-path data/datasets/ETH3D/${scene}/dslr_calibration_jpg
done
...
for scene in "${SCENES[@]}"; do
  ...
  python src/main.py --est-model-path data/results/acezero/ETH3D/${scene}/colmap/sparse/0 --gt-model-path data/datasets/ETH3D/${scene}/dslr_calibration_jpg
done
...
for scene in "${SCENES[@]}"; do
  ...
  python src/main.py --est-model-path data/results/glomap/ETH3D/${scene}/colmap/sparse/0 --gt-model-path data/datasets/ETH3D/${scene}/dslr_calibration_jpg
done
